...
import { fetchMetricById, fetchDataPoints, addDataPoint, fetchInsights } from '../api/metrics';
import {
  LineChart,
  Line,
  XAxis,
...
export function MetricDetailPage() {
  ...
  {pointsLoading ? (
    ...
    <p className="text-slate-400 text-sm">Add at least 2 datapoints to see trends.</p>
  ) : (
    <div className="h-72 w-full">
      <ResponsiveContainer width="100%" height="100%">
        ...
        <section className="bg-slate-900/70 border border-slate-800 rounded-2xl p-5">
          ...
          {!points?.length && <p className="text-slate-400 text-sm">No data points yet.</p>}
